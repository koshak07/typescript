...
const ffmpeg_bulder_1 = require("./ffmpeg.bulder");
class FfmpegExecutor extends command_executor_1.CommandExecutor {
    ...
    prompt() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const heigth = yield this.promptService.input("Высота", "number");
    ...
    build({ width, heigth, path, name, }) {
        const output = this.fileService.getFilePath(path, name, "mp4");
        const args = new ffmpeg_bulder_1.FfmpegBuilder()
            .input(path)
